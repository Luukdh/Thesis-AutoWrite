...
- "model": A zipped file collection containing the parameters of a CNN model.
- "optim": A zipped file collection containing the hyperparameters of an optimization algorithm.
