...
class UNet(nn.Module):
    def __init__(self, n_class):
        ...
        # input: 1x128x48
        self.e21 = nn.Conv1d(48, 96, kernel_size=9, padding=4, padding_mode='replicate') # output: 1x128x96
        self.e22 = nn.Conv1d(96, 96, kernel_size=9, padding=4, padding_mode='replicate') # output: 1x128x96
        ...
        # input: 1x32x192
        self.e41 = nn.Conv1d(192, 384, kernel_size=7, padding=3, padding_mode='replicate') # output: 1x32x384
        self.e42 = nn.Conv1d(384, 384, kernel_size=7, padding=3, padding_mode='replicate') # output: 1x32x384
        ...
        self.d31 = nn.Conv1d(192, 96, kernel_size=9, padding=4, padding_mode='replicate')
        self.d32 = nn.Conv1d(96, 96, kernel_size=9, padding=4, padding_mode='replicate')
