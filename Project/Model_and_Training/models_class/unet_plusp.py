...
class UNet(nn.Module):
    def __init__(self, n_class):
        ...
        # input: 1x8x1024
        self.e61 = nn.Conv1d(1024, 2048, kernel_size=3, padding=1, padding_mode='replicate') # output: 1x16x1024
        self.e62 = nn.Conv1d(2048, 2048, kernel_size=3, padding=1, padding_mode='replicate') # output: 1x16x1024


        # Decoder
        self.upconv0 = nn.ConvTranspose1d(2048, 1024, kernel_size=2, stride=2)
        self.d01 = nn.Conv1d(2048, 1024, kernel_size=3, padding=1, padding_mode='replicate')
        self.d02 = nn.Conv1d(1024, 1024, kernel_size=3, padding=1, padding_mode='replicate')
